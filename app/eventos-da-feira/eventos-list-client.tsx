  ...
  return (
    <>
      <form
        ...
        className="mb-4 grid grid-cols-1 gap-3 rounded bg-[#9c8f95] p-3 md:grid-cols-[1fr_auto_auto] md:items-center md:p-4"
      >
        ...
        {eventosFiltrados.length > 0 ? (
          eventosFiltrados.map((evento) => (
            ...
            >
              ...
              <article className="min-h-[110px] rounded bg-[#9c8f95] px-4 py-5 transition hover:bg-[#8f8388] md:px-6">
